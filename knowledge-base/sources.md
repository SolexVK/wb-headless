...
- ~~SEO-оптимизация карточки~~ — ✅ закрыто (уроки 10–11, файл [11](11-seo-optimizaciya.md)).
- Реклама и продвижение (3-й модуль: бидер, кластеры, идентификатор поисковой выдачи, ставки, стратегии в Радаре, ассоциативные конверсии в РК).
- Принадлежность запроса — отдельный крупный вебинар (Wildbox).
