...
export const COLOR_GROUPS = [
  ...
  // Бордо/винная гамма — ОТДЕЛЬНЫЙ канон (раньше «бордовый» падал в «красный», и остаток по
  // «бордо» не сопоставлялся с одноимённым цветом артикула). До «красного», чтобы выигрывал.
  ['бордо', /бордо|бордов|бургунд|винн|марсал/i],
  ['красный', /красн|вишн|терракот|рубин|алый/i],
