...
// Точную схему URL/тела MPSTATS уточняем при первом живом вызове — поэтому и путь,
// и имя query-параметра вынесены в env (перебиваются без правки кода).
const SEARCH_PATH = process.env.MPSTATS_SEARCH_PATH || '/wb/get/search/results';
