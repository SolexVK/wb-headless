...
<body><div class="wrap">
  ...
  <div class="foot">
    ...
    «Заработал» = выручка × процент выкупа (поправка на возвраты). Упущенная выручка — оценка спроса,
    не удовлетворённого из-за отсутствия товара на складе. Данные MPStats оценочные, пригодны для
