...
export async function buildShirtsData({ skus, d1, d2, categoryPath = 'Мужчинам/Рубашки', sizesQuery = 'рубашка мужская с длинным рукавом',
  ...
  marketMinus = 'коротк,тепл,тёпл,фланел,флане,клетк,полос,байков', onProgress } = {}) {
  const articles = [];
  ...
  const market = await buildShirtsMarket({ categoryPath, d1, d2, minus: marketMinus, topN: 10, top300: 300, sizesQuery });
