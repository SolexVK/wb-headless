...
- Проверено локально: `/`→planner (302 /login), `/calc`→tandemtrace (200, «UNIT-калькулятор WB»).
- **Осталось:** подтверждение публичного доступа с телефона (hairpin с самого Mac не показателен).
